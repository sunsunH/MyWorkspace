...
<!-- requried-jsfiles-for owl -->
	...
	<div class="content-bottom">
		<div class="col-md-4 bottom-grid2">
			...
			<div class="in-check" >
				<ul class="unit">
					<li><span><font color="#fff">订单编号</font-color></span></li>
					<li><span><font color="#fff">订单创建时间</font-color></span></li>		
					<li><span><font color="#fff">产品编号</font-color></span></li>
					<li><span><font color="#fff">产品数量/总价</font-color></span></li>
					<li> </li>
					<div class="clearfix"> </div>
				</ul>
				
				<c:forEach var="o" items="${requestScope.orders_items}">
				<form name="form1" action="addDiscuss.jsp" method="get">
				<ul class="cart-header">
					    <li><span class="name">${o.id}</span></li>
						<li><span class="name">${o.createtime}</span></li>
						<li><span class="cost"><input  value="${o.id}" name="productid"/></span></li>	
						<li><span>${o.quantity}/${o.price}<br/><input type="submit" value="去评论" name="discuss"  onclick="return check()"/>	</span></li>			
					<div class="clearfix"> </div>
				</ul></form>
				</c:forEach>
