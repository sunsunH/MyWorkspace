...
<!-- requried-jsfiles-for owl -->
	...
	<div class="content-bottom">
		<div class="col-md-4 bottom-grid1">
			<div class="contact-top heading">
				...
				<div class="col-md-3 contact-left">			
					...
					<div class="col-md-9 contact-right">
						<form action="AddDiscussServlet"  method="get" name="form1">
							<input readonly type="text" placeholder="用户名:<%= user.getUsername()%>"/>
							商品ID:<input readonly type="text" value="<%String productid=request.getParameter("productid");%><%=productid %>" name="productid"/>
							<textarea placeholder="请输入评论..." required=""name="cas"/></textarea>
