...
<!-- requried-jsfiles-for owl -->
	...
	<div class="content-bottom">
		...
		<h1>所有评论</h1>
		<c:forEach var="discuss" items="${requestScope.discuss}">
			<div class="news">
				<div class="foot">
					<span><h3>用户名:${discuss.usrid}&nbsp;&nbsp;&nbsp;创建时间:${discuss.createtime}</h3></span>
					<span><h3>产品编号:${discuss.productid}&nbsp;&nbsp;&nbsp;产品名称:${discuss.productname}</h3></span>
					<div class="clearfix"> </div>
				</div>
				<span><h3>评论:${discuss.cas}</h3></span>
			</div>
		</c:forEach>
		</div>
	<div class="clearfix"> </div>
